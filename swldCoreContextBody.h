...
static const char swldCoreContextBody[] =
  "{"
    "\"@context\":{"
      ...
      "\"attributeList\":{\"@id\":\"ngsi-ld:attributeList\",\"@type\":\"@vocab\"},"
      "\"attributeName\":{\"@id\":\"ngsi-ld:attributeName\",\"@type\":\"@vocab\"},"
      "\"attributeNames\":{\"@id\":\"ngsi-ld:attributeNames\",\"@type\":\"@vocab\"},"
      "\"attributeTypes\":{\"@id\":\"ngsi-ld:attributeTypes\",\"@type\":\"@vocab\"},"
      "\"attributes\":{\"@id\":\"ngsi-ld:attributes\",\"@type\":\"@vocab\"},"
      "\"attrs\":\"ngsi-ld:attrs\","
      "\"avg\":{\"@id\":\"ngsi-ld:avg\",\"@container\":\"@list\"},"
      ...
      "\"contextSourceExtras\":{\"@id\":\"ngsi-ld:contextSourceExtras\",\"@type\":\"@json\"},"
      "\"contextSourceInfo\":\"ngsi-ld:contextSourceInfo\","
      "\"contextSourceTimeAt\":{\"@id\":\"ngsi-ld:contextSourceTimeAt\",\"@type\":\"DateTime\"},"
      ...
      "\"createdAt\":{\"@id\":\"ngsi-ld:createdAt\",\"@type\":\"DateTime\"},"
      "\"csf\":\"ngsi-ld:csf\","
      "\"data\":\"ngsi-ld:data\","
      "\"dataset\":{\"@id\":\"ngsi-ld:hasDataset\",\"@container\":\"@index\"},"
      "\"datasetId\":{\"@id\":\"ngsi-ld:datasetId\",\"@type\":\"@id\"},"
      "\"deletedAt\":{\"@id\":\"ngsi-ld:deletedAt\",\"@type\":\"DateTime\"},"
      "\"description\":\"http://purl.org/dc/terms/description\","
      "\"detail\":\"ngsi-ld:detail\","
      "\"distinctCount\":{\"@id\":\"ngsi-ld:distinctCount\",\"@container\":\"@list\"},"
      ...
      "\"entityId\":{\"@id\":\"ngsi-ld:entityId\",\"@type\":\"@id\"},"
      "\"entityList\":{\"@id\":\"ngsi-ld:entityList\",\"@container\":\"@list\"},"
      "\"entityMap\":{\"@id\":\"ngsi-ld:hasEntityMap\",\"@container\":\"@index\"},"
      ...
      "\"instanceId\":{\"@id\":\"ngsi-ld:instanceId\",\"@type\":\"@id\"},"
      "\"isActive\":\"ngsi-ld:isActive\","
      "\"join\":\"ngsi-ld:join\","
      "\"joinLevel\":\"ngsi-ld:hasJoinLevel\","
      "\"json\":{\"@id\":\"ngsi-ld:hasJSON\",\"@type\":\"@json\"},"
      "\"jsonKeys\":\"ngsi-ld:jsonKeys\","
      "\"jsonldContext\":\"ngsi-ld:jsonldContext\","
      "\"jsons\":{\"@id\":\"ngsi-ld:jsons\",\"@container\":\"@list\"},"
      "\"key\":\"ngsi-ld:hasKey\","
      "\"lang\":\"ngsi-ld:lang\","
      "\"languageMap\":{\"@id\":\"ngsi-ld:hasLanguageMap\",\"@container\":\"@language\"},"
      "\"languageMaps\":{\"@id\":\"ngsi-ld:hasLanguageMaps\",\"@container\":\"@list\"},"
      "\"langString\":\"http://www.w3.org/1999/02/22-rdf-syntax-ns#langString\","
      "\"lastFailure\":{\"@id\":\"ngsi-ld:lastFailure\",\"@type\":\"DateTime\"},"
      "\"lastN\":\"ngsi-ld:lastN\","
      "\"lastNotification\":{\"@id\":\"ngsi-ld:lastNotification\",\"@type\":\"DateTime\"},"
      "\"lastSuccess\":{\"@id\":\"ngsi-ld:lastSuccess\",\"@type\":\"DateTime\"},"
      "\"lastUsedAt\":{\"@id\":\"ngsi-ld:lastUsedAt\",\"@type\":\"DateTime\"},"
      ...
      "\"max\":{\"@id\":\"ngsi-ld:max\",\"@container\":\"@list\"},"
      "\"min\":{\"@id\":\"ngsi-ld:min\",\"@container\":\"@list\"},"
      "\"mode\":\"ngsi-ld:mode\","
      "\"modifiedAt\":{\"@id\":\"ngsi-ld:modifiedAt\",\"@type\":\"DateTime\"},"
      "\"ngsildproof\":{\"@id\":\"ngsi-ld:ngsildproof\",\"@context\":[{\"entityIdSealed\":\"ngsi-ld:entityIdSealed\",\"entityTypeSealed\":{\"@id\":\"ngsi-ld:entityTypeSealed\",\"@type\":\"@vocab\"}},\"https://w3id.org/security/data-integrity/v2\"]},"
      "\"ngsildConformance\":\"ngsi-ld:ngsildConformance\","
      "\"notification\":\"ngsi-ld:notification\","
      "\"notificationTrigger\":\"ngsi-ld:notificationTrigger\","
      "\"notifiedAt\":{\"@id\":\"ngsi-ld:notifiedAt\",\"@type\":\"DateTime\"},"
      "\"notifierInfo\":\"ngsi-ld:notifierInfo\","
      "\"notUpdated\":\"ngsi-ld:notUpdated\","
      "\"object\":{\"@id\":\"ngsi-ld:hasObject\",\"@type\":\"@id\"},"
      "\"objectList\":{\"@id\":\"ngsi-ld:hasObjectList\",\"@container\":\"@list\"},"
      "\"objectLists\":{\"@id\":\"ngsi-ld:hasObjectLists\",\"@container\":\"@list\"},"
      "\"objects\":{\"@id\":\"ngsi-ld:hasObjects\",\"@container\":\"@list\"},"
      "\"objectType\":{\"@id\":\"ngsi-ld:hasObjectType\",\"@type\":\"@vocab\"},"
      "\"observationInterval\":\"ngsi-ld:observationInterval\","
      "\"observationSpace\":\"ngsi-ld:observationSpace\","
      "\"observedAt\":{\"@id\":\"ngsi-ld:observedAt\",\"@type\":\"DateTime\"},"
      "\"omit\":\"ngsi-ld:omit\","
      "\"operations\":\"ngsi-ld:operations\","
      "\"operationSpace\":\"ngsi-ld:operationSpace\","
      "\"orderBy\":{\"@container\":\"@list\",\"@id\":\"ngsi-ld:orderBy\"},"
      "\"ordering\":\"ngsi-ld:ordering\","
      "\"pick\":\"ngsi-ld:pick\","
      "\"previousJson\":{\"@id\":\"ngsi-ld:hasPreviousJson\",\"@type\":\"@json\"},"
      "\"previousLanguageMap\":{\"@id\":\"ngsi-ld:hasPreviousLanguageMap\",\"@container\":\"@language\"},"
      "\"previousObject\":{\"@id\":\"ngsi-ld:hasPreviousObject\",\"@type\":\"@id\"},"
      "\"previousObjectList\":{\"@id\":\"ngsi-ld:hasPreviousObjectList\",\"@container\":\"@list\"},"
      "\"previousValue\":\"ngsi-ld:hasPreviousValue\","
      "\"previousValueList\":{\"@id\":\"ngsi-ld:hasPreviousValueList\",\"@container\":\"@list\"},"
      "\"previousVocab\":{\"@id\":\"ngsi-ld:hasPreviousVocab\",\"@type\":\"@vocab\"},"
      "\"problemDetails\":{\"@id\":\"ngsi-ld:problemDetails\",\"@type\":\"@json\"},"
      ...
      "\"snapshotQueries\":{\"@id\":\"ngsi-ld:snapshotQueries\",\"@container\":\"@list\"},"
      "\"snapshotQueriesDetails\":{\"@id\":\"ngsi-ld:snapshotQueriesDetails\",\"@container\":\"@list\"},"
      "\"snapshotStatus\":\"ngsi-ld:snapshotStatus\","
      "\"snapshotTemporalQueries\":{\"@id\":\"ngsi-ld:snapshotTemporalQueries\",\"@container\":\"@list\"},"
      "\"snapshotTemporalQueriesDetails\":{\"@id\":\"ngsi-ld:snapshotTemporalQueriesDetails\",\"@container\":\"@list\"},"
      "\"splitEntities\":\"ngsi-ld:hasSplitEntities\","
      "\"startAt\":{\"@id\":\"ngsi-ld:startAt\",\"@type\":\"DateTime\"},"
      "\"status\":\"ngsi-ld:status\","
      "\"stddev\":{\"@id\":\"ngsi-ld:stddev\",\"@container\":\"@list\"},"
      "\"subscriptionId\":{\"@id\":\"ngsi-ld:subscriptionId\",\"@type\":\"@id\"},"
      "\"subscriptionName\":\"ngsi-ld:subscriptionName\","
      "\"success\":{\"@id\":\"ngsi-ld:success\",\"@type\":\"@id\"},"
      "\"sum\":{\"@id\":\"ngsi-ld:sum\",\"@container\":\"@list\"},"
      "\"sumsq\":{\"@id\":\"ngsi-ld:sumsq\",\"@container\":\"@list\"},"
      "\"sysAttrs\":\"ngsi-ld:sysAttrs\","
      "\"temporalQ\":\"ngsi-ld:temporalQ\","
      "\"tenant\":{\"@id\":\"ngsi-ld:tenant\",\"@type\":\"@id\"},"
      ...
      "\"totalCount\":{\"@id\":\"ngsi-ld:totalCount\",\"@container\":\"@list\"},"
      "\"triggerReason\":\"ngsi-ld:triggerReason\","
      "\"typeList\":{\"@id\":\"ngsi-ld:typeList\",\"@type\":\"@vocab\"},"
      "\"typeName\":{\"@id\":\"ngsi-ld:typeName\",\"@type\":\"@vocab\"},"
      "\"typeNames\":{\"@id\":\"ngsi-ld:typeNames\",\"@type\":\"@vocab\"},"
      "\"unchanged\":\"ngsi-ld:unchanged\","
      "\"unitCode\":\"ngsi-ld:unitCode\","
      "\"updated\":\"ngsi-ld:updated\","
      "\"uri\":\"ngsi-ld:uri\","
      "\"value\":\"ngsi-ld:hasValue\","
      "\"valueList\":{\"@id\":\"ngsi-ld:hasValueList\",\"@container\":\"@list\"},"
      "\"valueLists\":{\"@id\":\"ngsi-ld:hasValueLists\",\"@container\":\"@list\"},"
      "\"values\":{\"@id\":\"ngsi-ld:hasValues\",\"@container\":\"@list\"},"
      "\"valueType\":{\"@id\":\"ngsi-ld:hasValueType\",\"@type\":\"@vocab\"},"
      "\"vocab\":{\"@id\":\"ngsi-ld:hasVocab\",\"@type\":\"@vocab\"},"
      "\"vocabs\":{\"@id\":\"ngsi-ld:hasVocabs\",\"@container\":\"@list\"},"
      "\"watchedAttributes\":{\"@id\":\"ngsi-ld:watchedAttributes\",\"@type\":\"@vocab\"},"
